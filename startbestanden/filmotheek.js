...
db.films.insert({filmNr: 4, titel: "Le fabuleux destin d'Amelie Poulain", beschrijving: "Amelie, an innocent and naive girl in Paris, with her own sense of justice, decides to help those around her and along the way, discovers love.", genre: "Comedy Romantiek", duur: "2u 2min", regisseur: "Jean-Pierre Jeunet", release:new Date("2001-05-25T01:00+01:00"), foto: "ameliepoulain.jpg"});
db.films.insert({filmNr: 5, titel: "Alien", beschrijving: "The commercial vessel Nostromo receives a distress call from an unexplored planet. After searching for survivors, the crew heads home only to realize that a deadly bioform has joined them.", genre: "Sci-Fi Horror", duur: "1u 57min", regisseur: "Ridley Scott", release:new Date("1979-09-13T01:00+01:00"), foto: "alien.jpg"});
